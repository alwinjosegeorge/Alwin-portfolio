...
const HeroSection = () => {
  return (
    {/* The 'animated-bg' class and 'min-h-screen flex items-center justify-center relative overflow-hidden' gives the video-like dark, immersive background style. */}
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden animated-bg">
      {/* Background geometric elements - These create the pulsating, floating glow effects seen in the video. */}
